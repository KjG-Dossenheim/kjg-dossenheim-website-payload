  ...
  return (
    <StepItemContext.Provider value={{ step, state, isDisabled: disabled, isLoading }}>
      <div
        ...
        className={cn(
          'group/step relative flex items-center justify-center not-last:flex-1 group-data-[orientation=horizontal]/stepper-nav:flex-row group-data-[orientation=vertical]/stepper-nav:flex-col',
          className,
        )}
        data-state={state}
  ...
  return (
    ...
    >
      <div className="absolute">
        {indicators?.loading && isLoading
          ? indicators.loading
          : indicators?.completed && state === 'completed'
            ? indicators.completed
            : indicators?.active && state === 'active'
              ? indicators.active
              : indicators?.inactive && state === 'inactive'
                ? indicators.inactive
                : children}
      </div>
    </div>
