...
import type { AnmeldungData } from './Columns'
...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
  ...
  const handleRowClick = (row: TData) => {
    const anmeldungData = row as unknown as AnmeldungData
    router.push(`/admin/collections/sommerfreizeitAnmeldung/${anmeldungData.id}`)
  }
    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex items-center justify-between py-4">
        <div className="text-muted-foreground flex-1 text-sm">
          {table.getFilteredRowModel().rows.length} Anmeldungen gesamt
        </div>
