...
import { NavbarNavigationMenuLink } from './NavigationMenuLink'
import {
  Sheet,
  SheetContent,
  SheetTrigger,
  ...
  return (
    <>
      <Link
        ...
        className={cn(buttonVariants({ variant: 'default' }), mobile ? 'w-full' : undefined)}
      >
      ...
      <Link
        ...
        className={cn(buttonVariants({ variant: 'outline' }), mobile ? 'w-full' : undefined)}
      >
          ...
          <div className="grid gap-1 p-2 md:min-w-70">
            {item.subNavigation.map((subItem) => (
              ...
              >
                ...
                <div>
                  <div className="text-foreground text-sm font-semibold">{subItem.title}</div>
                </div>
              </NavbarNavigationMenuLink>
            ))}
          </div>
